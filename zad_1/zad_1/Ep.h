...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel1->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &Ep::panel1_Paint);
			// 
			// textBox2
			// 
			...
			this->EK->Location = System::Drawing::Point(177, 37);
			this->EK->Name = L"EK";
			this->EK->Size = System::Drawing::Size(152, 66);
			this->EK->TabIndex = 4;
			this->EK->Text = L"EK";
			this->EK->UseVisualStyleBackColor = false;
			this->EK->Click += gcnew System::EventHandler(this, &Ep::EK);
			// 
			// Ep
			// 
